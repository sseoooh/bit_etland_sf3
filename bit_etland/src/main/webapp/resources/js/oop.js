...
Customer.prototype.setName =name=>{
	/*this.name ='[아이디]'+name '+name 이건 자바문법*/
	Object.getPrototypeOf(Customer.prototype)
	.setName('[아이디]'+name);
};
Customer.prototype.setGrade = function(grade){this.grade = grade;};
Customer.prototype.setCustNo = function(custNo){this.custNo = custNo;};
	Customer.prototype.getGrade = function(){return this.grade;};
	Customer.prototype.getCustNo = function(){return this.custNo;};
