...
<form id="form" name="form" >
	<div class="grid-container">
	    ...
	    <div class="grid-item" id="item_7">포 토</div>
	    <div class="grid-item" id="item_8"><input type="text" id="photo" name="photo" ></div>
	    <div class="grid-item" id="item_9">노 트</div>
	    <div class="grid-item" id="item_10"><input type="text" id="notes" name="notes" ></div>
	    <div class="grid-item" id="item_11">상 세</div>
	    <div class="grid-item" id="item_12"><input type="text" id="desc" name="desc" ></div>
	    
	    <div class="grid-item" id="item_13"><input type="submit" id="confirm_btn" value='확인'></div>
	    <div class="grid-item" id="item_14"><input type="reset" id="cancel_btn" value='등록'> </div>
